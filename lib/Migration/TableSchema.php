...
abstract class TableSchema
{
    ...
    public const FK_INDICES = [
        Inquiry::TABLE => [
            ...
            Option::TABLE => ['constraintColumn' => 'inquiry_id','onDelete' => 'CASCADE'],
    ...
    public const COMMON_INDICES = [
        'inqs_inqs_owners_non_deleted' => [
            'table' => Inquiry::TABLE,
            'name' => 'inqs_inqs_owners_non_deleted',
            'unique' => false,
            'columns' => ['owner', 'deleted']
        ],
        'attachments_inquiry' => [
            'table' => Attachment::TABLE,
            'name' => 'attachments_inquiry',
            'unique' => false,
            'columns' => ['inquiry_id']
        ],
        'supports_inquiry' => [
            'table' => Support::TABLE,
            'name' => 'supports_inquiry',
            'unique' => false, 
            'columns' => ['inquiry_id']
        ],
        'supports_option' => [
            'table' => Support::TABLE,
            'name' => 'supports_option',
            'unique' => false,  
            'columns' => ['option_id']
        ],
        'supports_user' => [
    ...
    public const TABLES = [
        ...
        Inquiry::TABLE => [
            ...
            'deleted' => ['type' => Types::BIGINT, 'options' => ['notnull' => true, 'default' => 0, 'length' => 20]],
            'owned_group' => ['type' => Types::BOOLEAN, 'options' => ['notnull' => false, 'default' => 0, 'length' => 20]],
            'access' => ['type' => Types::STRING, 'options' => ['notnull' => true, 'default' => 'private', 'length' => 50]],
            'quorum' => ['type' => Types::BIGINT, 'options' => ['notnull' => true, 'default' => 0, 'length' => 20]],
