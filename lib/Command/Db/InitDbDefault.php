...
class InitDbDefault extends Command
{
	...
	private array $inquiryTypes = [
		...
		[
			...
			'fields' => ['parent_inquiry_id', 'resolved_by_suggestion_id'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'is_option' => 1,
			'created' => '',
		...
		// --- Article / Chapter for Law Proposal ---
		[
		...
		// --- Objection and Suggestion linkage ---
		[
		...
		[
			...
			'fields' => ['facilitator_id', 'quorum'],
			'allowed_response' => ['Suggestion', 'petition','proposal'],
		...
		[
			...
			'fields' => ['quorum', 'parent_law_id'],
			'allowed_response' => ['objection', 'suggestion'],
			'allowed_transformation' => ['law_proposal','project','initiative'],
			'created' => '',
			'is_option' => 0,
		],
		[
			...
			'fields' => ['quorum', 'signatures_count'],
			'allowed_response' => null,
		...
		[
			...
			'fields' => ['budget', 'deadline', 'assigned_unit'],
			'allowed_response' => ['project_review', 'suggestion'],
			'allowed_transformation' => ['law_proposal','initiative'],
			'created' => '',
			'is_option' => 0,
		],
		[
			...
			'fields' => ['evaluation_score', 'progress_status'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		[
			...
			'label' => 'Objection',
			'description' => 'Objection linked to another inquiry, can be resolved via suggestions.',
			'fields' => ['linked_argument_id', 'resolved'],
			'allowed_response' => ['suggestion'],
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		[
			...
			'icon' => 'Lightbulb',
			'label' => 'Suggestion',
			'description' => 'Suggestion to solve or refine an objection.',
			'fields' => ['linked_objection_id', 'accepted'],
			'allowed_response' => null,
		...
		[
			...
			'fields' => ['co_owners', 'quorum'],
			'allowed_response' => ['proposal','petition'],
		...
		[
			...
			'fields' => ['facilitator_id', 'participants_list'],
			'allowed_response' => ['proposal','suggestion'],
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		],
		...
		[
			...
			'fields' => ['parent_law_id', 'article_map', 'legal_status', 'facilitator_id'],
			'allowed_response' => ['amendment','objection','response'],
		...
		[
			...
			'fields' => ['parent_law_id', 'article_ref', 'facilitator_id'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		[
			...
			'fields' => ['draft_text', 'article_map', 'facilitator_id'],
		...
		[
			...
			'fields' => ['policy_area', 'impact_assessment'],
		...
		[
			...
			'fields' => ['request_type', 'assigned_unit', 'processing_deadline', 'resolution_date'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		[
			...
			'fields' => ['severity', 'assigned_unit', 'resolution_date'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		[
			...
			'fields' => ['support_type', 'eligibility', 'assigned_unit', 'processing_deadline', 'resolution_date'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		[
			...
			'description' => 'Request for financial aid or scholarship.',
			'fields' => ['support_type'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
		...
		[
			...
			'description' => 'Request for childcare or nursery access.',
			'fields' => ['support_type'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
		...
		[
			...
			'description' => 'Request for social or affordable housing.',
			'fields' => ['support_type'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
		...
		[
			...
			'fields' => ['topic', 'start_date', 'end_date', 'form_schema'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		// --- Official ---
		[
			'inquiry_type' => 'official_cityhall',
			'family' => 'official',
			'icon' => 'City',
			'label' => 'Official Response from City Hall',
			'description' => 'Response authored by an official, linked to an inquiry.',
			'fields' => ['responder_id', 'resolution_status', 'response'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
			'is_option' => 0,
		...
		[
			'inquiry_type' => 'official_experts',
			'family' => 'official',
			'icon' => 'AccountTie',
			'label' => 'Official Response from Experts',
			'description' => 'Independent expert response.',
			'fields' => ['responder_id', 'resolution_status', 'response'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
		...
		[
			'inquiry_type' => 'official_commissions',
			'family' => 'official',
			'icon' => 'AccountBalance',
			'label' => 'Official Commissions',
			'description' => 'Commission response linked to an inquiry.',
			'fields' => ['responder_id', 'resolution_status', 'response'],
			'allowed_response' => null,
			'allowed_transformation' => null,
			'created' => '',
