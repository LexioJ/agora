...
const be = "agora", ge = "1.5.0-rc1";
import { m as I, d as g, B as O, C as R, j as u, I as M, R as D, J as A, e as p, o as i, w as o, r as f, G as w, K as j, f as v, a as d, c as l, z as m, u as n, L as E, M as P, l as c, O as T, _ as $, P as z, k, t as N, y as W, h as G, p as J } from "./ThumbIcon.vue_vue_type_style_index_0_scoped_3109c301_lang-DJZOxAH0.chunk.mjs";
import { r as K } from "./NcRichText-CETsOVBU-D8OHrkEp.chunk.mjs";
import { _ as Z } from "./AgoraAppIcon.vue_vue_type_script_setup_true_lang-BJx1NZlo.chunk.mjs";
...
const X = I(F, [["render", Q]]), Y = { class: "user-bubble__name" }, x = { key: 0, class: "user-bubble__secondary" }, ee = g({ __name: "NcUserBubble", props: O({ avatarImage: { default: void 0 }, user: { default: void 0 }, displayName: { default: void 0 }, showUserStatus: { type: Boolean }, url: { default: void 0 }, to: { default: void 0 }, primary: { type: Boolean }, size: { default: 20 }, margin: { default: 2 } }, { open: { type: Boolean }, openModifiers: {} }), emits: O(["click"], ["update:open"]), setup(t, { emit: r }) {
  ...
  }), h = u(() => !!a.avatarImage), q = u(() => ({ marginInlineStart: `${a.margin}px` })), B = u(() => {
  ...
  }), H = u(() => B.value ? a.url : void 0), S = u(() => B.value ? "a" : a.to ? D : "div"), U = u(() => ({ height: `${a.size}px`, lineHeight: `${a.size}px`, borderRadius: `${a.size / 2}px` }));
  return A([() => a.displayName, () => a.user], () => {
    !a.displayName && a.user;
  }), (s, y) => (i(), p(w(s.$slots.default ? n(T) : X), { shown: e.value, "onUpdate:shown": y[1] || (y[1] = (b) => e.value = b), class: "user-bubble__wrapper", trigger: "hover focus" }, { trigger: o(({ attrs: b }) => [(i(), p(w(S.value), j({ class: ["user-bubble__content", { "user-bubble__content--primary": s.primary }], style: U.value, to: s.to, href: H.value }, b, { onClick: y[0] || (y[0] = (L) => C("click", L)) }), { default: o(() => [v(n(E), { url: h.value && _.value ? s.avatarImage : void 0, "icon-class": h.value && !_.value ? s.avatarImage : void 0, user: s.user, "display-name": s.displayName, size: s.size - s.margin * 2, style: P(q.value), "disable-tooltip": true, "disable-menu": true, "hide-status": !s.showUserStatus, class: "user-bubble__avatar" }, null, 8, ["url", "icon-class", "user", "display-name", "size", "style", "hide-status"]), d("span", Y, c(s.displayName || s.user), 1), s.$slots.name ? (i(), l("span", x, [f(s.$slots, "name", {}, void 0, true)])) : m("", true)]), _: 2 }, 1040, ["class", "style", "to", "href"]))]), default: o(() => [f(s.$slots, "default", {}, void 0, true)]), _: 3 }, 40, ["shown"]));
...
function oe(t, r, e, a, C, _) {
  return i(), l("span", j(t.$attrs, { "aria-hidden": e.title ? null : "true", "aria-label": e.title, class: "material-design-icon calendar-end-icon", role: "img", onClick: r[0] || (r[0] = (h) => t.$emit("click", h)) }), [(i(), l("svg", { fill: e.fillColor, class: "material-design-icon__svg", width: e.size, height: e.size, viewBox: "0 0 24 24" }, [d("path", ie, [e.title ? (i(), l("title", ne, c(e.title), 1)) : m("", true)])], 8, re))], 16, te);
}
const le = $(se, [["render", oe]]), ce = { key: 0 }, ue = g({ __name: "BadgeSmallDiv", props: { tag: { default: "span" } }, setup(t) {
  return (r, e) => (i(), p(w(r.tag), { class: "badge-small" }, { default: o(() => [f(r.$slots, "icon", {}, void 0, true), r.$slots.default ? (i(), l("span", ce, [f(r.$slots, "default", {}, void 0, true)])) : m("", true)]), _: 3 }));
} }), V = $(ue, [["__scopeId", "data-v-a75cba4f"]]), de = { key: 0, class: "agora_widget" }, pe = { class: "widget_header" }, me = ["href"], fe = { class: "description" }, he = { class: "clamped" }, ye = { key: 0, class: "widget_footer" }, ve = g({ __name: "Reference", props: { richObject: {} }, setup(t) {
  const r = t.richObject?.inquiry?.expiry ? z.fromMillis(t.richObject.inquiry.expiry * 1e3).diffNow("hours").hours < 36 ? "warning" : "success" : "";
  return (e, a) => e.richObject ? (i(), l("div", de, [d("div", pe, [v(n(Z), { size: 20, class: "title-icon" }), d("a", { class: "title", href: e.richObject.inquiry.url, target: "_blank" }, c(e.richObject.inquiry.title), 9, me), e.richObject.inquiry.participated ? (i(), p(V, { key: 0, class: "success" }, { default: o(() => [k(c(n(N)("agora", "participated")), 1)]), _: 1 })) : e.richObject.inquiry.expired ? (i(), p(V, { key: 1, class: "error" }, { default: o(() => [k(c(n(N)("agora", "closed")), 1)]), _: 1 })) : e.richObject.inquiry.expiry > 0 ? (i(), p(V, { key: 2, class: W(n(r)) }, { icon: o(() => [v(le, { size: 16 })]), default: o(() => [k(" " + c(n(z).fromMillis(e.richObject.inquiry.expiry * 1e3).toRelative()), 1)]), _: 1 }, 8, ["class"])) : m("", true)]), d("div", fe, [d("span", he, c(e.richObject.inquiry.description), 1)]), e.richObject.inquiry.ownerId ? (i(), l("div", ye, [d("span", null, c(n(N)("agora", "By")), 1), v(n(ae), { user: e.richObject.inquiry.ownerId, "display-name": e.richObject.inquiry.ownerDisplayName }, null, 8, ["user", "display-name"])])) : m("", true)])) : m("", true);
