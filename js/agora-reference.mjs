...
const ge = "agora", be = "1.5.0-beta";
import { m as I, a as b, B as O, C as R, j as c, I as M, R as D, J as A, f as p, o as i, w as o, r as f, G as w, K as j, g as v, b as d, c as l, z as m, u as n, L as E, M as P, l as u, O as T, _ as $, P as z, k, t as N, y as W, i as G, p as J } from "./ThumbIcon.vue_vue_type_style_index_0_scoped_3109c301_lang-BHFm0nDv.chunk.mjs";
import { r as K } from "./NcRichText-CETsOVBU-D-QDiRZ9.chunk.mjs";
import { _ as Z } from "./AgoraAppIcon.vue_vue_type_script_setup_true_lang-BdvFy5tM.chunk.mjs";

const F = {};
function Q(t, r) {
  return i(), l("div", null, [f(t.$slots, "trigger")]);
}
const X = I(F, [["render", Q]]), Y = { class: "user-bubble__name" }, x = { key: 0, class: "user-bubble__secondary" }, ee = b({ __name: "NcUserBubble", props: O({ avatarImage: { default: void 0 }, user: { default: void 0 }, displayName: { default: void 0 }, showUserStatus: { type: Boolean }, url: { default: void 0 }, to: { default: void 0 }, primary: { type: Boolean }, size: { default: 20 }, margin: { default: 2 } }, { open: { type: Boolean }, openModifiers: {} }), emits: O(["click"], ["update:open"]), setup(t, { emit: r }) {
...
const le = $(se, [["render", oe]]), ue = { key: 0 }, ce = b({ __name: "BadgeSmallDiv", props: { tag: { default: "span" } }, setup(t) {
...
} }), V = $(ce, [["__scopeId", "data-v-a75cba4f"]]), de = { key: 0, class: "agora_widget" }, pe = { class: "widget_header" }, me = ["href"], fe = { class: "description" }, he = { class: "clamped" }, ye = { key: 0, class: "widget_footer" }, ve = b({ __name: "Reference", props: { richObject: {} }, setup(t) {
...
} }), _e = $(ve, [["__scopeId", "data-v-1ff32f68"]]);
