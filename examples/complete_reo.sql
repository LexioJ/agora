...
-- ============================
CREATE TABLE IF NOT EXISTS oc_agora_location (
...
-- ============================
CREATE TABLE IF NOT EXISTS oc_agora_category (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255) NOT NULL DEFAULT '',
    parent_id BIGINT DEFAULT 0,
    created TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
-- ============================
DELETE FROM oc_agora_location WHERE name LIKE 'Polynésie%' OR name LIKE 'Îles%';


INSERT INTO oc_agora_location (name, parent_id) VALUES
-- --- Pays/Territoire ---
...
DELETE FROM oc_agora_category WHERE name IN ('Écologie & Ressources', 'Aménagement & Développement', 'Santé & Bien-être', 'Citoyenneté & Société', 'Éducation & Spiritualité');

-- ============================
-- Insertion: Catégories (traduites/adaptées)
-- ============================
INSERT INTO oc_agora_category (name, parent_id) VALUES
...
DELETE FROM oc_agora_comments;
DELETE FROM oc_agora_supports;
...
(5001, NULL, 'proposal', 'Créer plus de pistes cyclables à Papeete', 'Extension du réseau cyclable entre la mairie et la gare maritime.', 101, 6, 'admin', UNIX_TIMESTAMP()-86400*200, 0, UNIX_TIMESTAMP()+86400*160, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*190, NULL, 'accepted', 'active', 1, 1),

(5002, NULL, 'debate', 'Limiter les navettes de croisière dans le lagon de Bora Bora', 'Faut-il interdire les gros bateaux dans les zones coralliennes sensibles ?', 102, 11, 'moderator', UNIX_TIMESTAMP()-86400*150, 0, UNIX_TIMESTAMP()+86400*120, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*145, NULL, 'accepted', 'active', 1, 1),

(5003, NULL, 'project', 'Installation de panneaux solaires sur les écoles de Moorea', 'Projet de transition énergétique soutenu par la commune.', 103, 5, 'test', UNIX_TIMESTAMP()-86400*100, 0, UNIX_TIMESTAMP()+86400*200, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*95, NULL, 'accepted', 'active', 1, 1),

(5004, NULL, 'petition', 'Protéger la passe de Tiputa à Rangiroa', 'Interdire les ancrages sur les coraux dans la passe célèbre.', 104, 3, 'test2', UNIX_TIMESTAMP()-86400*80, 0, UNIX_TIMESTAMP()+86400*60, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*75, NULL, 'accepted', 'active', 1, 1),

(5005, NULL, 'grievance', 'Bruit excessif des scooters des marines la nuit à Taiohae', 'Plainte concernant le trafic nocturne des deux-roues.', 105, 21, 'test3', UNIX_TIMESTAMP()-86400*60, 0, UNIX_TIMESTAMP()+86400*120, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*55, NULL, 'accepted', 'active', 1, 1),

(5006, NULL, 'suggestion', 'Installer des parois anti-bruit près de l''aéroport', 'Suggestion liée à la plainte sur le bruit des avions.', 103, 6, 'admin', UNIX_TIMESTAMP()-86400*55, 0, UNIX_TIMESTAMP()+86400*100, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*50, 5005, 'accepted', 'active', 1, 1),

(5007, NULL, 'proposal', 'Planter 2''000 arbres à Tahiti', 'Plan de reforestation urbaine pour lutter contre les îlots de chaleur.', 101, 2, 'moderator', UNIX_TIMESTAMP()-86400*40, 0, UNIX_TIMESTAMP()+86400*200, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*35, NULL, 'accepted', 'active', 1, 1),

(5008, NULL, 'official', 'Réponse officielle : Arbres à Tahiti', 'Le service des espaces verts soutient le projet.', 101, 2, 'official', UNIX_TIMESTAMP()-86400*38, 0, UNIX_TIMESTAMP()+86400*120, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*37, 5007, 'accepted', 'active', 1, 1),

(5009, NULL, 'project', 'Créer un jardin partagé à Tubuai', 'Espace vert ouvert géré par les habitants pour l''autosuffisance.', 106, 17, 'test', UNIX_TIMESTAMP()-86400*30, 0, UNIX_TIMESTAMP()+86400*200, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*25, NULL, 'accepted', 'active', 1, 1),

(5010, NULL, 'proposal', 'Installer une serre permaculture', 'Extension du projet 5009 pour produire des légumes tropicaux.', 106, 4, 'test2', UNIX_TIMESTAMP()-86400*28, 0, UNIX_TIMESTAMP()+86400*150, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*25, 5009, 'accepted', 'active', 1, 1),

(5011, NULL, 'grievance', 'Retards récurrents des avions inter-îles aux Marquises', 'Nombreuses plaintes depuis la saison des pluies.', 105, 9, 'test3', UNIX_TIMESTAMP()-86400*27, 0, UNIX_TIMESTAMP()+86400*90, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*26, NULL, 'accepted', 'active', 1, 1),

(5012, NULL, 'suggestion', 'Améliorer le suivi GPS des petits avions', 'Suggestion liée à la plainte 5011 sur la fiabilité des vols.', 105, 9, 'admin', UNIX_TIMESTAMP()-86400*26, 0, UNIX_TIMESTAMP()+86400*100, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*25, 5011, 'accepted', 'active', 1, 1),

(5013, NULL, 'petition', 'Interdire les jet-skis près des sites de plongée aux Tuamotu', 'Réduction du bruit et protection de la faune sous-marine.', 102, 3, 'moderator', UNIX_TIMESTAMP()-86400*24, 0, UNIX_TIMESTAMP()+86400*60, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*22, NULL, 'accepted', 'active', 1, 1),

(5014, NULL, 'debate', 'Faut-il enseigner le Reo Tahiti dans toutes les écoles de l''archipel ?', 'Débat public sur la place de la langue ancestrale à l''école.', 103, 26, 'test', UNIX_TIMESTAMP()-86400*20, 0, UNIX_TIMESTAMP()+86400*90, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*18, NULL, 'accepted', 'active', 1, 1),

(5015, NULL, 'proposal', 'Toitures végétalisées pour les bâtiments publics de Papeete', 'Projet de verdissement urbain pour la capitale.', 101, 2, 'test2', UNIX_TIMESTAMP()-86400*15, 0, UNIX_TIMESTAMP()+86400*200, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*14, NULL, 'accepted', 'active', 1, 1),

(5016, NULL, 'official', 'Réponse officielle : Toitures végétalisées', 'Projet accepté en phase d''étude par la direction de l''environnement.', 101, 2, 'official', UNIX_TIMESTAMP()-86400*14, 0, UNIX_TIMESTAMP()+86400*120, 0, '', 'open', 'always', UNIX_TIMESTAMP()-86400*13, 5015, 'accepted', 'active', 1, 1);
...
-- 5106 — Moorea / Suggestion liée
(5106, NULL, 'suggestion',
...
-- 5108 — Réponse officielle (Tahiti)
(5108, NULL, 'official',
...
-- 5109 — Tubuai / Jardin communautaire
(5109, NULL, 'project',
...
-- 5112 — Suggestion avions GPS
(5112, NULL, 'suggestion',
...
-- 5116 — Réponse officielle toits verts
(5116, NULL, 'official',
