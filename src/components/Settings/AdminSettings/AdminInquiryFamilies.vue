...
const addFamily = async () => {
  ...
  newFamily.value = {
    ...
    description: '',
    icon: '',
    sort_order: familiesStore.families.length
  }
}

const updateFamily = async (family) => {
  await familiesStore.updateFamily(family.id, family)
  editingFamily.value = null
}

const deleteFamily = async (familyId) => {
  if (confirm(t('agora', 'Are you sure you want to delete this family?'))) {
    await familiesStore.deleteFamily(familyId)
  }
}
</script>
...
<template>
  <div class="inquiry-families">
    ...
    <div class="families-list">
      <div v-for="family in familiesStore.families" :key="family.id" class="family-item">
